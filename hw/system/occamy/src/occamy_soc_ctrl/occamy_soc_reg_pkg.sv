...
package occamy_soc_reg_pkg;
  ...
  // HW -> register type
  typedef struct packed {
    occamy_soc_hw2reg_intr_state_reg_t intr_state; // [55:52]
    occamy_soc_hw2reg_chip_id_reg_t chip_id; // [51:50]
  ...
  parameter logic [BlockAw-1:0] OCCAMY_SOC_CHIP_ID_OFFSET = 10'h 10;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_SCRATCH_0_OFFSET = 10'h 14;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_SCRATCH_1_OFFSET = 10'h 18;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_SCRATCH_2_OFFSET = 10'h 1c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_SCRATCH_3_OFFSET = 10'h 20;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_BOOT_MODE_OFFSET = 10'h 24;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_0_OFFSET = 10'h 28;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_1_OFFSET = 10'h 2c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_2_OFFSET = 10'h 30;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_3_OFFSET = 10'h 34;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_4_OFFSET = 10'h 38;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_5_OFFSET = 10'h 3c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_6_OFFSET = 10'h 40;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_7_OFFSET = 10'h 44;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_8_OFFSET = 10'h 48;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_9_OFFSET = 10'h 4c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_10_OFFSET = 10'h 50;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_11_OFFSET = 10'h 54;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_12_OFFSET = 10'h 58;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_13_OFFSET = 10'h 5c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_14_OFFSET = 10'h 60;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_15_OFFSET = 10'h 64;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_16_OFFSET = 10'h 68;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_17_OFFSET = 10'h 6c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_18_OFFSET = 10'h 70;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_19_OFFSET = 10'h 74;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_20_OFFSET = 10'h 78;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_21_OFFSET = 10'h 7c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_22_OFFSET = 10'h 80;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_23_OFFSET = 10'h 84;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_24_OFFSET = 10'h 88;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_25_OFFSET = 10'h 8c;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_26_OFFSET = 10'h 90;
  parameter logic [BlockAw-1:0] OCCAMY_SOC_PAD_27_OFFSET = 10'h 94;
  ...
  parameter logic [3:0] OCCAMY_SOC_PERMIT [173] = '{
    ...
    4'b 1111, // index[141] OCCAMY_SOC_RO_START_ADDR_LOW_0_QUADRANT_6
    4'b 0011, // index[142] OCCAMY_SOC_RO_START_ADDR_HIGH_0_QUADRANT_6
    4'b 1111, // index[143] OCCAMY_SOC_RO_END_ADDR_LOW_0_QUADRANT_6
    4'b 0011, // index[144] OCCAMY_SOC_RO_END_ADDR_HIGH_0_QUADRANT_6
    4'b 1111, // index[145] OCCAMY_SOC_RO_START_ADDR_LOW_1_QUADRANT_6
    4'b 0011, // index[146] OCCAMY_SOC_RO_START_ADDR_HIGH_1_QUADRANT_6
    4'b 1111, // index[147] OCCAMY_SOC_RO_END_ADDR_LOW_1_QUADRANT_6
    4'b 0011, // index[148] OCCAMY_SOC_RO_END_ADDR_HIGH_1_QUADRANT_6
    4'b 1111, // index[149] OCCAMY_SOC_RO_START_ADDR_LOW_2_QUADRANT_6
    4'b 0011, // index[150] OCCAMY_SOC_RO_START_ADDR_HIGH_2_QUADRANT_6
    4'b 1111, // index[151] OCCAMY_SOC_RO_END_ADDR_LOW_2_QUADRANT_6
    4'b 0011, // index[152] OCCAMY_SOC_RO_END_ADDR_HIGH_2_QUADRANT_6
    4'b 1111, // index[153] OCCAMY_SOC_RO_START_ADDR_LOW_3_QUADRANT_6
    4'b 0011, // index[154] OCCAMY_SOC_RO_START_ADDR_HIGH_3_QUADRANT_6
    4'b 1111, // index[155] OCCAMY_SOC_RO_END_ADDR_LOW_3_QUADRANT_6
    4'b 0011, // index[156] OCCAMY_SOC_RO_END_ADDR_HIGH_3_QUADRANT_6
    4'b 1111, // index[157] OCCAMY_SOC_RO_START_ADDR_LOW_0_QUADRANT_7
    4'b 0011, // index[158] OCCAMY_SOC_RO_START_ADDR_HIGH_0_QUADRANT_7
    4'b 1111, // index[159] OCCAMY_SOC_RO_END_ADDR_LOW_0_QUADRANT_7
    4'b 0011, // index[160] OCCAMY_SOC_RO_END_ADDR_HIGH_0_QUADRANT_7
    4'b 1111, // index[161] OCCAMY_SOC_RO_START_ADDR_LOW_1_QUADRANT_7
    4'b 0011, // index[162] OCCAMY_SOC_RO_START_ADDR_HIGH_1_QUADRANT_7
    4'b 1111, // index[163] OCCAMY_SOC_RO_END_ADDR_LOW_1_QUADRANT_7
    4'b 0011, // index[164] OCCAMY_SOC_RO_END_ADDR_HIGH_1_QUADRANT_7
    4'b 1111, // index[165] OCCAMY_SOC_RO_START_ADDR_LOW_2_QUADRANT_7
    4'b 0011, // index[166] OCCAMY_SOC_RO_START_ADDR_HIGH_2_QUADRANT_7
    4'b 1111, // index[167] OCCAMY_SOC_RO_END_ADDR_LOW_2_QUADRANT_7
    4'b 0011, // index[168] OCCAMY_SOC_RO_END_ADDR_HIGH_2_QUADRANT_7
    4'b 1111, // index[169] OCCAMY_SOC_RO_START_ADDR_LOW_3_QUADRANT_7
    4'b 0011, // index[170] OCCAMY_SOC_RO_START_ADDR_HIGH_3_QUADRANT_7
    4'b 1111, // index[171] OCCAMY_SOC_RO_END_ADDR_LOW_3_QUADRANT_7
    4'b 0011  // index[172] OCCAMY_SOC_RO_END_ADDR_HIGH_3_QUADRANT_7
  };
