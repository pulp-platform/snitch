...
(
  ...
  /// PCIe Ports
  `AXI_FLAT_MASTER_PORT(pcie, logic [47:0], logic [4:0], logic [511:0], logic [63:0], logic [0:0])
  ,`AXI_FLAT_SLAVE_PORT(pcie, logic [47:0], logic [4:0], logic [511:0], logic [63:0], logic [0:0])
  /// HBM2e Ports
  /// HBI Ports
);
