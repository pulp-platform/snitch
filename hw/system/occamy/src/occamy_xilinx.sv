...
(
    ...
    output logic           [47:0] m_apb_hbm_ctrl_paddr,
    output apb_pkg::prot_t        m_apb_hbm_ctrl_pprot,
    output logic                  m_apb_hbm_ctrl_psel,
    output logic                  m_apb_hbm_ctrl_penable,
    output logic                  m_apb_hbm_ctrl_pwrite,
    output logic           [31:0] m_apb_hbm_ctrl_pwdata,
    output logic           [ 3:0] m_apb_hbm_ctrl_pstrb,
    input  logic                  m_apb_hbm_ctrl_pready,
    input  logic           [31:0] m_apb_hbm_ctrl_prdata,
    input  logic                  m_apb_hbm_ctrl_pslverr,
  ...
  apb_a48_d32_req_t apb_hbm_ctrl_req_o;
  apb_a48_d32_rsp_t apb_hbm_ctrl_rsp_i;
  `APB_FLATTEN_MASTER(hbm_ctrl, apb_hbm_ctrl_req_o, apb_hbm_ctrl_rsp_i)
