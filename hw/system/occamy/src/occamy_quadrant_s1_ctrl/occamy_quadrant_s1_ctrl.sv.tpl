...
(
  ...
  localparam addr_t InternalBaseAddr = ClusterBaseOffset +
    tile_id_i * NrClustersS1Quadrant * ClusterAddressSpace + ${nr_clusters} * ClusterAddressSpace;
  ...
  assign soc_out_req_o = ${quadrant_s1_ctrl_xbar.out_soc.req_name()};
  assign ${quadrant_s1_ctrl_xbar.out_soc.rsp_name()} = soc_out_rsp_i;
  assign ${quadrant_s1_ctrl_xbar.in_soc.req_name()} = narrow_in_req_i;
  assign narrow_in_rsp_o = ${quadrant_s1_ctrl_xbar.in_soc.rsp_name()};

  // Connect quadrant narrow ports
  assign narrow_out_req_o =  ${quadrant_s1_ctrl_xbar.out_quadrant.req_name()};
  assign ${quadrant_s1_ctrl_xbar.out_quadrant.rsp_name()} = narrow_out_rsp_i;
  assign ${quadrant_s1_ctrl_xbar.in_quadrant.req_name()} = narrow_in_req_i;
  assign narrow_in_rsp_o = ${quadrant_s1_ctrl_xbar.in_quadrant.rsp_name()};

  // Toward inernal register file
  <%
    quad_regs_regbus = quadrant_s1_ctrl_xbar.out_internal \
