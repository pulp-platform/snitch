...
(
 ...
 // Calculate cluster base address based on `tile id`.
  ...
  ///////////////////////////////
  ${soc_narrow_xbar.out_s1_quadrant_0.req_type()} narrow_cluster_in_iwc_req;
  ${soc_narrow_xbar.out_s1_quadrant_0.rsp_type()} narrow_cluster_in_iwc_rsp;

  <% narrow_cluster_in_iwc = soc_narrow_xbar.out_s1_quadrant_0.copy(name="narrow_cluster_in_iwc") \
  ...
  ////////////////////////////
  ${soc_wide_xbar.out_s1_quadrant_0.req_type()} wide_cluster_in_iwc_req;
  ${soc_wide_xbar.out_s1_quadrant_0.rsp_type()} wide_cluster_in_iwc_rsp;

  <% wide_cluster_in_iwc = soc_wide_xbar.out_s1_quadrant_0.copy(name="wide_cluster_in_iwc") \
...
% for i in range(nr_clusters):
  ...
  // Cluster ${i} //
  ///////////////
  <% narrow_cluster_iwc = narrow_xbar_quadrant_s1.__dict__["out_cluster_{}".format(i)].change_iw(context, 2, "narrow_out_iwc_{}".format(i)) %>
  <% wide_cluster_iwc = wide_xbar_quadrant_s1.__dict__["out_cluster_{}".format(i)].change_iw(context, 2, "wide_out_iwc_{}".format(i)) %>
  ...
  occamy_cluster_wrapper i_occamy_cluster_${i} (
    ...
    .narrow_in_req_i (${narrow_cluster_iwc.req_name()}),
    .narrow_in_resp_o (${narrow_cluster_iwc.rsp_name()}),
    .narrow_out_req_o  (${narrow_xbar_quadrant_s1.__dict__["in_cluster_{}".format(i)].req_name()}),
    .narrow_out_resp_i (${narrow_xbar_quadrant_s1.__dict__["in_cluster_{}".format(i)].rsp_name()}),
    .wide_out_req_o  (${wide_xbar_quadrant_s1.__dict__["in_cluster_{}".format(i)].req_name()}),
    .wide_out_resp_i (${wide_xbar_quadrant_s1.__dict__["in_cluster_{}".format(i)].rsp_name()}),
    .wide_in_req_i (${wide_cluster_iwc.req_name()}),
    .wide_in_resp_o (${wide_cluster_iwc.rsp_name()})
  );
