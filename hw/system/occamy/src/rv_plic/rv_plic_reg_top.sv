...
module rv_plic_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[70] = (reg_addr == RV_PLIC_IP_0_OFFSET);
    addr_hit[71] = (reg_addr == RV_PLIC_IP_1_OFFSET);
    addr_hit[72] = (reg_addr == RV_PLIC_IP_2_OFFSET);
    addr_hit[73] = (reg_addr == RV_PLIC_LE_0_OFFSET);
    addr_hit[74] = (reg_addr == RV_PLIC_LE_1_OFFSET);
    addr_hit[75] = (reg_addr == RV_PLIC_LE_2_OFFSET);
    addr_hit[76] = (reg_addr == RV_PLIC_IE0_0_OFFSET);
    addr_hit[77] = (reg_addr == RV_PLIC_IE0_1_OFFSET);
    addr_hit[78] = (reg_addr == RV_PLIC_IE0_2_OFFSET);
    addr_hit[79] = (reg_addr == RV_PLIC_IE1_0_OFFSET);
    addr_hit[80] = (reg_addr == RV_PLIC_IE1_1_OFFSET);
    addr_hit[81] = (reg_addr == RV_PLIC_IE1_2_OFFSET);
    addr_hit[82] = (reg_addr == RV_PLIC_THRESHOLD0_OFFSET);
    addr_hit[83] = (reg_addr == RV_PLIC_CC0_OFFSET);
    addr_hit[84] = (reg_addr == RV_PLIC_MSIP0_OFFSET);
    addr_hit[85] = (reg_addr == RV_PLIC_THRESHOLD1_OFFSET);
    addr_hit[86] = (reg_addr == RV_PLIC_CC1_OFFSET);
    addr_hit[87] = (reg_addr == RV_PLIC_MSIP1_OFFSET);
    addr_hit[88] = (reg_addr == RV_PLIC_ALERT_TEST_OFFSET);
  end
  ...
  assign le_0_le_0_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_0_wd = reg_wdata[0];

  assign le_0_le_1_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_1_wd = reg_wdata[1];

  assign le_0_le_2_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_2_wd = reg_wdata[2];

  assign le_0_le_3_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_3_wd = reg_wdata[3];

  assign le_0_le_4_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_4_wd = reg_wdata[4];

  assign le_0_le_5_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_5_wd = reg_wdata[5];

  assign le_0_le_6_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_6_wd = reg_wdata[6];

  assign le_0_le_7_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_7_wd = reg_wdata[7];

  assign le_0_le_8_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_8_wd = reg_wdata[8];

  assign le_0_le_9_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_9_wd = reg_wdata[9];

  assign le_0_le_10_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_10_wd = reg_wdata[10];

  assign le_0_le_11_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_11_wd = reg_wdata[11];

  assign le_0_le_12_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_12_wd = reg_wdata[12];

  assign le_0_le_13_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_13_wd = reg_wdata[13];

  assign le_0_le_14_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_14_wd = reg_wdata[14];

  assign le_0_le_15_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_15_wd = reg_wdata[15];

  assign le_0_le_16_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_16_wd = reg_wdata[16];

  assign le_0_le_17_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_17_wd = reg_wdata[17];

  assign le_0_le_18_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_18_wd = reg_wdata[18];

  assign le_0_le_19_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_19_wd = reg_wdata[19];

  assign le_0_le_20_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_20_wd = reg_wdata[20];

  assign le_0_le_21_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_21_wd = reg_wdata[21];

  assign le_0_le_22_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_22_wd = reg_wdata[22];

  assign le_0_le_23_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_23_wd = reg_wdata[23];

  assign le_0_le_24_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_24_wd = reg_wdata[24];

  assign le_0_le_25_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_25_wd = reg_wdata[25];

  assign le_0_le_26_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_26_wd = reg_wdata[26];

  assign le_0_le_27_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_27_wd = reg_wdata[27];

  assign le_0_le_28_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_28_wd = reg_wdata[28];

  assign le_0_le_29_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_29_wd = reg_wdata[29];

  assign le_0_le_30_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_30_wd = reg_wdata[30];

  assign le_0_le_31_we = addr_hit[73] & reg_we & !reg_error;
  assign le_0_le_31_wd = reg_wdata[31];

  assign le_1_le_32_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_32_wd = reg_wdata[0];

  assign le_1_le_33_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_33_wd = reg_wdata[1];

  assign le_1_le_34_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_34_wd = reg_wdata[2];

  assign le_1_le_35_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_35_wd = reg_wdata[3];

  assign le_1_le_36_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_36_wd = reg_wdata[4];

  assign le_1_le_37_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_37_wd = reg_wdata[5];

  assign le_1_le_38_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_38_wd = reg_wdata[6];

  assign le_1_le_39_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_39_wd = reg_wdata[7];

  assign le_1_le_40_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_40_wd = reg_wdata[8];

  assign le_1_le_41_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_41_wd = reg_wdata[9];

  assign le_1_le_42_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_42_wd = reg_wdata[10];

  assign le_1_le_43_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_43_wd = reg_wdata[11];

  assign le_1_le_44_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_44_wd = reg_wdata[12];

  assign le_1_le_45_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_45_wd = reg_wdata[13];

  assign le_1_le_46_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_46_wd = reg_wdata[14];

  assign le_1_le_47_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_47_wd = reg_wdata[15];

  assign le_1_le_48_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_48_wd = reg_wdata[16];

  assign le_1_le_49_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_49_wd = reg_wdata[17];

  assign le_1_le_50_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_50_wd = reg_wdata[18];

  assign le_1_le_51_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_51_wd = reg_wdata[19];

  assign le_1_le_52_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_52_wd = reg_wdata[20];

  assign le_1_le_53_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_53_wd = reg_wdata[21];

  assign le_1_le_54_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_54_wd = reg_wdata[22];

  assign le_1_le_55_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_55_wd = reg_wdata[23];

  assign le_1_le_56_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_56_wd = reg_wdata[24];

  assign le_1_le_57_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_57_wd = reg_wdata[25];

  assign le_1_le_58_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_58_wd = reg_wdata[26];

  assign le_1_le_59_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_59_wd = reg_wdata[27];

  assign le_1_le_60_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_60_wd = reg_wdata[28];

  assign le_1_le_61_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_61_wd = reg_wdata[29];

  assign le_1_le_62_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_62_wd = reg_wdata[30];

  assign le_1_le_63_we = addr_hit[74] & reg_we & !reg_error;
  assign le_1_le_63_wd = reg_wdata[31];

  assign le_2_le_64_we = addr_hit[75] & reg_we & !reg_error;
  assign le_2_le_64_wd = reg_wdata[0];

  assign le_2_le_65_we = addr_hit[75] & reg_we & !reg_error;
  assign le_2_le_65_wd = reg_wdata[1];

  assign le_2_le_66_we = addr_hit[75] & reg_we & !reg_error;
  assign le_2_le_66_wd = reg_wdata[2];

  assign le_2_le_67_we = addr_hit[75] & reg_we & !reg_error;
  assign le_2_le_67_wd = reg_wdata[3];

  assign le_2_le_68_we = addr_hit[75] & reg_we & !reg_error;
  assign le_2_le_68_wd = reg_wdata[4];

  assign le_2_le_69_we = addr_hit[75] & reg_we & !reg_error;
  assign le_2_le_69_wd = reg_wdata[5];

  assign ie0_0_e_0_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_0_wd = reg_wdata[0];

  assign ie0_0_e_1_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_1_wd = reg_wdata[1];

  assign ie0_0_e_2_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_2_wd = reg_wdata[2];

  assign ie0_0_e_3_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_3_wd = reg_wdata[3];

  assign ie0_0_e_4_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_4_wd = reg_wdata[4];

  assign ie0_0_e_5_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_5_wd = reg_wdata[5];

  assign ie0_0_e_6_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_6_wd = reg_wdata[6];

  assign ie0_0_e_7_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_7_wd = reg_wdata[7];

  assign ie0_0_e_8_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_8_wd = reg_wdata[8];

  assign ie0_0_e_9_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_9_wd = reg_wdata[9];

  assign ie0_0_e_10_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_10_wd = reg_wdata[10];

  assign ie0_0_e_11_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_11_wd = reg_wdata[11];

  assign ie0_0_e_12_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_12_wd = reg_wdata[12];

  assign ie0_0_e_13_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_13_wd = reg_wdata[13];

  assign ie0_0_e_14_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_14_wd = reg_wdata[14];

  assign ie0_0_e_15_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_15_wd = reg_wdata[15];

  assign ie0_0_e_16_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_16_wd = reg_wdata[16];

  assign ie0_0_e_17_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_17_wd = reg_wdata[17];

  assign ie0_0_e_18_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_18_wd = reg_wdata[18];

  assign ie0_0_e_19_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_19_wd = reg_wdata[19];

  assign ie0_0_e_20_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_20_wd = reg_wdata[20];

  assign ie0_0_e_21_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_21_wd = reg_wdata[21];

  assign ie0_0_e_22_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_22_wd = reg_wdata[22];

  assign ie0_0_e_23_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_23_wd = reg_wdata[23];

  assign ie0_0_e_24_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_24_wd = reg_wdata[24];

  assign ie0_0_e_25_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_25_wd = reg_wdata[25];

  assign ie0_0_e_26_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_26_wd = reg_wdata[26];

  assign ie0_0_e_27_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_27_wd = reg_wdata[27];

  assign ie0_0_e_28_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_28_wd = reg_wdata[28];

  assign ie0_0_e_29_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_29_wd = reg_wdata[29];

  assign ie0_0_e_30_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_30_wd = reg_wdata[30];

  assign ie0_0_e_31_we = addr_hit[76] & reg_we & !reg_error;
  assign ie0_0_e_31_wd = reg_wdata[31];

  assign ie0_1_e_32_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_32_wd = reg_wdata[0];

  assign ie0_1_e_33_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_33_wd = reg_wdata[1];

  assign ie0_1_e_34_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_34_wd = reg_wdata[2];

  assign ie0_1_e_35_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_35_wd = reg_wdata[3];

  assign ie0_1_e_36_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_36_wd = reg_wdata[4];

  assign ie0_1_e_37_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_37_wd = reg_wdata[5];

  assign ie0_1_e_38_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_38_wd = reg_wdata[6];

  assign ie0_1_e_39_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_39_wd = reg_wdata[7];

  assign ie0_1_e_40_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_40_wd = reg_wdata[8];

  assign ie0_1_e_41_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_41_wd = reg_wdata[9];

  assign ie0_1_e_42_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_42_wd = reg_wdata[10];

  assign ie0_1_e_43_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_43_wd = reg_wdata[11];

  assign ie0_1_e_44_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_44_wd = reg_wdata[12];

  assign ie0_1_e_45_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_45_wd = reg_wdata[13];

  assign ie0_1_e_46_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_46_wd = reg_wdata[14];

  assign ie0_1_e_47_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_47_wd = reg_wdata[15];

  assign ie0_1_e_48_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_48_wd = reg_wdata[16];

  assign ie0_1_e_49_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_49_wd = reg_wdata[17];

  assign ie0_1_e_50_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_50_wd = reg_wdata[18];

  assign ie0_1_e_51_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_51_wd = reg_wdata[19];

  assign ie0_1_e_52_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_52_wd = reg_wdata[20];

  assign ie0_1_e_53_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_53_wd = reg_wdata[21];

  assign ie0_1_e_54_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_54_wd = reg_wdata[22];

  assign ie0_1_e_55_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_55_wd = reg_wdata[23];

  assign ie0_1_e_56_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_56_wd = reg_wdata[24];

  assign ie0_1_e_57_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_57_wd = reg_wdata[25];

  assign ie0_1_e_58_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_58_wd = reg_wdata[26];

  assign ie0_1_e_59_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_59_wd = reg_wdata[27];

  assign ie0_1_e_60_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_60_wd = reg_wdata[28];

  assign ie0_1_e_61_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_61_wd = reg_wdata[29];

  assign ie0_1_e_62_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_62_wd = reg_wdata[30];

  assign ie0_1_e_63_we = addr_hit[77] & reg_we & !reg_error;
  assign ie0_1_e_63_wd = reg_wdata[31];

  assign ie0_2_e_64_we = addr_hit[78] & reg_we & !reg_error;
  assign ie0_2_e_64_wd = reg_wdata[0];

  assign ie0_2_e_65_we = addr_hit[78] & reg_we & !reg_error;
  assign ie0_2_e_65_wd = reg_wdata[1];

  assign ie0_2_e_66_we = addr_hit[78] & reg_we & !reg_error;
  assign ie0_2_e_66_wd = reg_wdata[2];

  assign ie0_2_e_67_we = addr_hit[78] & reg_we & !reg_error;
  assign ie0_2_e_67_wd = reg_wdata[3];

  assign ie0_2_e_68_we = addr_hit[78] & reg_we & !reg_error;
  assign ie0_2_e_68_wd = reg_wdata[4];

  assign ie0_2_e_69_we = addr_hit[78] & reg_we & !reg_error;
  assign ie0_2_e_69_wd = reg_wdata[5];

  assign ie1_0_e_0_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_0_wd = reg_wdata[0];

  assign ie1_0_e_1_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_1_wd = reg_wdata[1];

  assign ie1_0_e_2_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_2_wd = reg_wdata[2];

  assign ie1_0_e_3_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_3_wd = reg_wdata[3];

  assign ie1_0_e_4_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_4_wd = reg_wdata[4];

  assign ie1_0_e_5_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_5_wd = reg_wdata[5];

  assign ie1_0_e_6_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_6_wd = reg_wdata[6];

  assign ie1_0_e_7_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_7_wd = reg_wdata[7];

  assign ie1_0_e_8_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_8_wd = reg_wdata[8];

  assign ie1_0_e_9_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_9_wd = reg_wdata[9];

  assign ie1_0_e_10_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_10_wd = reg_wdata[10];

  assign ie1_0_e_11_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_11_wd = reg_wdata[11];

  assign ie1_0_e_12_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_12_wd = reg_wdata[12];

  assign ie1_0_e_13_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_13_wd = reg_wdata[13];

  assign ie1_0_e_14_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_14_wd = reg_wdata[14];

  assign ie1_0_e_15_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_15_wd = reg_wdata[15];

  assign ie1_0_e_16_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_16_wd = reg_wdata[16];

  assign ie1_0_e_17_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_17_wd = reg_wdata[17];

  assign ie1_0_e_18_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_18_wd = reg_wdata[18];

  assign ie1_0_e_19_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_19_wd = reg_wdata[19];

  assign ie1_0_e_20_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_20_wd = reg_wdata[20];

  assign ie1_0_e_21_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_21_wd = reg_wdata[21];

  assign ie1_0_e_22_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_22_wd = reg_wdata[22];

  assign ie1_0_e_23_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_23_wd = reg_wdata[23];

  assign ie1_0_e_24_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_24_wd = reg_wdata[24];

  assign ie1_0_e_25_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_25_wd = reg_wdata[25];

  assign ie1_0_e_26_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_26_wd = reg_wdata[26];

  assign ie1_0_e_27_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_27_wd = reg_wdata[27];

  assign ie1_0_e_28_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_28_wd = reg_wdata[28];

  assign ie1_0_e_29_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_29_wd = reg_wdata[29];

  assign ie1_0_e_30_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_30_wd = reg_wdata[30];

  assign ie1_0_e_31_we = addr_hit[79] & reg_we & !reg_error;
  assign ie1_0_e_31_wd = reg_wdata[31];

  assign ie1_1_e_32_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_32_wd = reg_wdata[0];

  assign ie1_1_e_33_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_33_wd = reg_wdata[1];

  assign ie1_1_e_34_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_34_wd = reg_wdata[2];

  assign ie1_1_e_35_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_35_wd = reg_wdata[3];

  assign ie1_1_e_36_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_36_wd = reg_wdata[4];

  assign ie1_1_e_37_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_37_wd = reg_wdata[5];

  assign ie1_1_e_38_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_38_wd = reg_wdata[6];

  assign ie1_1_e_39_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_39_wd = reg_wdata[7];

  assign ie1_1_e_40_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_40_wd = reg_wdata[8];

  assign ie1_1_e_41_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_41_wd = reg_wdata[9];

  assign ie1_1_e_42_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_42_wd = reg_wdata[10];

  assign ie1_1_e_43_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_43_wd = reg_wdata[11];

  assign ie1_1_e_44_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_44_wd = reg_wdata[12];

  assign ie1_1_e_45_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_45_wd = reg_wdata[13];

  assign ie1_1_e_46_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_46_wd = reg_wdata[14];

  assign ie1_1_e_47_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_47_wd = reg_wdata[15];

  assign ie1_1_e_48_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_48_wd = reg_wdata[16];

  assign ie1_1_e_49_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_49_wd = reg_wdata[17];

  assign ie1_1_e_50_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_50_wd = reg_wdata[18];

  assign ie1_1_e_51_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_51_wd = reg_wdata[19];

  assign ie1_1_e_52_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_52_wd = reg_wdata[20];

  assign ie1_1_e_53_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_53_wd = reg_wdata[21];

  assign ie1_1_e_54_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_54_wd = reg_wdata[22];

  assign ie1_1_e_55_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_55_wd = reg_wdata[23];

  assign ie1_1_e_56_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_56_wd = reg_wdata[24];

  assign ie1_1_e_57_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_57_wd = reg_wdata[25];

  assign ie1_1_e_58_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_58_wd = reg_wdata[26];

  assign ie1_1_e_59_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_59_wd = reg_wdata[27];

  assign ie1_1_e_60_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_60_wd = reg_wdata[28];

  assign ie1_1_e_61_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_61_wd = reg_wdata[29];

  assign ie1_1_e_62_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_62_wd = reg_wdata[30];

  assign ie1_1_e_63_we = addr_hit[80] & reg_we & !reg_error;
  assign ie1_1_e_63_wd = reg_wdata[31];

  assign ie1_2_e_64_we = addr_hit[81] & reg_we & !reg_error;
  assign ie1_2_e_64_wd = reg_wdata[0];

  assign ie1_2_e_65_we = addr_hit[81] & reg_we & !reg_error;
  assign ie1_2_e_65_wd = reg_wdata[1];

  assign ie1_2_e_66_we = addr_hit[81] & reg_we & !reg_error;
  assign ie1_2_e_66_wd = reg_wdata[2];

  assign ie1_2_e_67_we = addr_hit[81] & reg_we & !reg_error;
  assign ie1_2_e_67_wd = reg_wdata[3];

  assign ie1_2_e_68_we = addr_hit[81] & reg_we & !reg_error;
  assign ie1_2_e_68_wd = reg_wdata[4];

  assign ie1_2_e_69_we = addr_hit[81] & reg_we & !reg_error;
  assign ie1_2_e_69_wd = reg_wdata[5];

  assign threshold0_we = addr_hit[82] & reg_we & !reg_error;
  assign threshold0_wd = reg_wdata[2:0];

  assign cc0_we = addr_hit[83] & reg_we & !reg_error;
  assign cc0_wd = reg_wdata[6:0];
  assign cc0_re = addr_hit[83] & reg_re & !reg_error;

  assign msip0_we = addr_hit[84] & reg_we & !reg_error;
  assign msip0_wd = reg_wdata[0];

  assign threshold1_we = addr_hit[85] & reg_we & !reg_error;
  assign threshold1_wd = reg_wdata[2:0];

  assign cc1_we = addr_hit[86] & reg_we & !reg_error;
  assign cc1_wd = reg_wdata[6:0];
  assign cc1_re = addr_hit[86] & reg_re & !reg_error;

  assign msip1_we = addr_hit[87] & reg_we & !reg_error;
  assign msip1_wd = reg_wdata[0];

  assign alert_test_we = addr_hit[88] & reg_we & !reg_error;
