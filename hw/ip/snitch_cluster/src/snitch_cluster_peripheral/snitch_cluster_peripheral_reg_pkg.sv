...
package snitch_cluster_peripheral_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    snitch_cluster_peripheral_reg2hw_perf_counter_enable_mreg_t [1:0] perf_counter_enable; // [237:184]
    ...
    snitch_cluster_peripheral_reg2hw_perf_counter_enable_mreg_t [1:0] perf_counter_enable; // [260:249]
    snitch_cluster_peripheral_reg2hw_hart_select_mreg_t [1:0] hart_select; // [248:229]
    snitch_cluster_peripheral_reg2hw_perf_counter_mreg_t [1:0] perf_counter; // [228:131]
    snitch_cluster_peripheral_reg2hw_wake_up_reg_t wake_up; // [130:98]
    snitch_cluster_peripheral_reg2hw_perf_counter_enable_mreg_t [1:0] perf_counter_enable; // [227:216]
    snitch_cluster_peripheral_reg2hw_hart_select_mreg_t [1:0] hart_select; // [215:196]
    snitch_cluster_peripheral_reg2hw_perf_counter_mreg_t [1:0] perf_counter; // [195:98]
    snitch_cluster_peripheral_reg2hw_cl_clint_set_reg_t cl_clint_set; // [97:65]
    snitch_cluster_peripheral_reg2hw_cl_clint_clear_reg_t cl_clint_clear; // [64:32]
  ...
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_WAKE_UP_OFFSET = 7'h 30;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_HW_BARRIER_OFFSET = 7'h 38;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_ICACHE_PREFETCH_ENABLE_OFFSET = 7'h 40;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_HART_SELECT_OFFSET = 7'h 10;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_PERF_COUNTER_0_OFFSET = 7'h 18;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_PERF_COUNTER_1_OFFSET = 7'h 20;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_WAKE_UP_OFFSET = 7'h 28;
  ...
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_CL_CLINT_SET_OFFSET = 6'h 28;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_CL_CLINT_CLEAR_OFFSET = 6'h 30;
  parameter logic [BlockAw-1:0] SNITCH_CLUSTER_PERIPHERAL_HW_BARRIER_OFFSET = 6'h 38;
  ...
  parameter logic [3:0] SNITCH_CLUSTER_PERIPHERAL_PERMIT [9] = '{
    ...
    4'b 1111, // index[6] SNITCH_CLUSTER_PERIPHERAL_WAKE_UP
    4'b 1111, // index[7] SNITCH_CLUSTER_PERIPHERAL_HW_BARRIER
    4'b 0001  // index[8] SNITCH_CLUSTER_PERIPHERAL_ICACHE_PREFETCH_ENABLE
  parameter logic [3:0] SNITCH_CLUSTER_PERIPHERAL_PERMIT [8] = '{
    ...
    4'b 1111, // index[5] SNITCH_CLUSTER_PERIPHERAL_CL_CLINT_SET
    4'b 1111, // index[6] SNITCH_CLUSTER_PERIPHERAL_CL_CLINT_CLEAR
    4'b 1111  // index[7] SNITCH_CLUSTER_PERIPHERAL_HW_BARRIER
  };
