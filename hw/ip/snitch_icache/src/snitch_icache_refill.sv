...
module snitch_icache_refill #(
    ...
    assign refill_qlen_o   = $unsigned(BeatsPerRefill-1);
    ...
    if (CFG.LINE_WIDTH > CFG.FILL_DW) begin : g_data_concat
        always_ff @(posedge clk_i, negedge rst_ni) begin
            ...
            end else if (refill_pvalid_i && refill_pready_o) begin
        ...
        assign response_data =
          refill_pdata_i >> (in_req_addr_i[CFG.FILL_ALIGN-1:CFG.LINE_ALIGN] * CFG.LINE_WIDTH);
