module snitch_ssr_mux #(
  ...
  output data_t [1:0]      ssr_int_rdata_o,
  ...
  input  data_t [0:0]      ssr_int_wdata_i,
  ...
  output logic  [0:0]      ssr_wdone_o
   ...
   assign ssr_raddr_o[1:0] = ssr_int_raddr_i;
   assign ssr_rdata_o = ssr_rdata_i[1:0];
   assign ssr_rvalid_o[1:0] = ssr_int_rvalid_i;
   assign ssr_rdone_o[1:0] = ssr_int_rdone_i;
