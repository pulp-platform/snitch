...
package riscv_instr;
  ...
  localparam logic [31:0] VFSUMEX_S_H        = 32'b1011110??????????010?????0110011;
  localparam logic [31:0] VFNSUMEX_S_H       = 32'b1011111??????????010?????0110011;
  ...
  localparam logic [31:0] VFSUMEX_S_AH       = 32'b1011110??????????010?????0110011;
  localparam logic [31:0] VFNSUMEX_S_AH      = 32'b1011111??????????010?????0110011;
  ...
  localparam logic [31:0] VFSUMEX_H_B        = 32'b1011110??????????011?????0110011;
  localparam logic [31:0] VFNSUMEX_H_B       = 32'b1011111??????????011?????0110011;
  ...
  localparam logic [31:0] VFSUMEX_H_AB       = 32'b1011110??????????011?????0110011;
  localparam logic [31:0] VFNSUMEX_H_AB      = 32'b1011111??????????011?????0110011;
  ...
  localparam logic [31:0] VFSUMEX_AH_AB      = 32'b1011110??????????011?????0110011;
  localparam logic [31:0] VFNSUMEX_AH_AB     = 32'b1011111??????????011?????0110011;
