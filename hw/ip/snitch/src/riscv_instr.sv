...
package riscv_instr;
  ...
  localparam logic [31:0] DMSRC              = 32'b0000000??????????000?????0101011;
  localparam logic [31:0] DMDST              = 32'b0000001??????????000?????0101011;
  localparam logic [31:0] DMCPYI             = 32'b0000010??????????000?????0101011;
  localparam logic [31:0] DMCPY              = 32'b0000011??????????000?????0101011;
  localparam logic [31:0] DMSTATI            = 32'b0000100??????????000?????0101011;
  localparam logic [31:0] DMSTAT             = 32'b0000101??????????000?????0101011;
  localparam logic [31:0] DMSTR              = 32'b0000110??????????000?????0101011;
  localparam logic [31:0] DMREP              = 32'b0000111??????????000?????0101011;
  localparam logic [31:0] FREP               = 32'b?????????????????????????0001011;
