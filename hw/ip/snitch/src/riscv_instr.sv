...
package riscv_instr;
  ...
  localparam logic [11:0] CSR_INT_SSR = 12'h7c2;
  ...
  localparam logic [31:0] PV_ADD_N           = 32'b0000000??????????010?????1010111;
  localparam logic [31:0] PV_ADD_SC_N        = 32'b0000000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_SUB_N           = 32'b0000100??????????010?????1010111;
  localparam logic [31:0] PV_SUB_SC_N        = 32'b0000100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_AVG_N           = 32'b0001000??????????010?????1010111;
  localparam logic [31:0] PV_AVG_SC_N        = 32'b0001000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_AVGU_N          = 32'b0001100??????????010?????1010111;
  localparam logic [31:0] PV_AVGU_SC_N       = 32'b0001100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_MIN_N           = 32'b0010000??????????010?????1010111;
  localparam logic [31:0] PV_MIN_SC_N        = 32'b0010000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_MINU_N          = 32'b0010100??????????010?????1010111;
  localparam logic [31:0] PV_MINU_SC_N       = 32'b0010100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_MAX_N           = 32'b0011000??????????010?????1010111;
  localparam logic [31:0] PV_MAX_SC_N        = 32'b0011000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_MAXU_N          = 32'b0011100??????????010?????1010111;
  localparam logic [31:0] PV_MAXU_SC_N       = 32'b0011100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_SRL_N           = 32'b0100000??????????010?????1010111;
  localparam logic [31:0] PV_SRL_SC_N        = 32'b0100000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_SRA_N           = 32'b0100100??????????010?????1010111;
  localparam logic [31:0] PV_SRA_SC_N        = 32'b0100100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_SLL_N           = 32'b0101000??????????010?????1010111;
  localparam logic [31:0] PV_SLL_SC_N        = 32'b0101000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_OR_N            = 32'b0101100??????????010?????1010111;
  localparam logic [31:0] PV_OR_SC_N         = 32'b0101100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_XOR_N           = 32'b0110000??????????010?????1010111;
  localparam logic [31:0] PV_XOR_SC_N        = 32'b0110000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_AND_N           = 32'b0110100??????????010?????1010111;
  localparam logic [31:0] PV_AND_SC_N        = 32'b0110100??????????011?????1010111;
  localparam logic [31:0] PV_ABS_H           = 32'b011100000000?????000?????1010111;
  localparam logic [31:0] PV_ABS_B           = 32'b011100000000?????001?????1010111;
  localparam logic [31:0] PV_ABS_N           = 32'b011100000000?????010?????1010111;
  ...
  localparam logic [31:0] PV_DOTUP_N         = 32'b1000000??????????010?????1010111;
  localparam logic [31:0] PV_DOTUP_SC_N      = 32'b1000000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_DOTUSP_N        = 32'b1000100??????????010?????1010111;
  localparam logic [31:0] PV_DOTUSP_SC_N     = 32'b1000100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_DOTSP_N         = 32'b1001100??????????010?????1010111;
  localparam logic [31:0] PV_DOTSP_SC_N      = 32'b1001100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_SDOTUP_N        = 32'b1010000??????????010?????1010111;
  localparam logic [31:0] PV_SDOTUP_SC_N     = 32'b1010000??????????011?????1010111;
  ...
  localparam logic [31:0] PV_SDOTUSP_N       = 32'b1010100??????????010?????1010111;
  localparam logic [31:0] PV_SDOTUSP_SC_N    = 32'b1010100??????????011?????1010111;
  ...
  localparam logic [31:0] PV_SDOTSP_N        = 32'b1011100??????????010?????1010111;
  localparam logic [31:0] PV_SDOTSP_SC_N     = 32'b1011100??????????011?????1010111;
  localparam logic [31:0] PV_SHUFFLE2_H      = 32'b1100100??????????000?????1010111;
  localparam logic [31:0] PV_SHUFFLE2_B      = 32'b1100100??????????001?????1010111;
  localparam logic [31:0] PV_SHUFFLE2_N      = 32'b1100100??????????010?????1010111;
