...
package riscv_instr;
  ...
  localparam logic [31:0] VFCVT_AH_AB        = 32'b100110000111?????001?????0110011;
  localparam logic [31:0] VFCVTU_AH_AB       = 32'b100110000111?????101?????0110011;
  localparam logic [31:0] VFCVT_AB_AH        = 32'b100110000101?????011?????0110011;
  localparam logic [31:0] VFCVTU_AB_AH       = 32'b100110000101?????111?????0110011;
  localparam logic [31:0] VFSUM_S            = 32'b1011100??????????000?????0110011;
  localparam logic [31:0] VFSUMEXP_S_H       = 32'b1011101??????????000?????0110011;
  localparam logic [31:0] VFSUMEXP_S_AH      = 32'b1011101??????????000?????0110011;
  ...
  localparam logic [31:0] VFSUM_H            = 32'b1011100??????????010?????0110011;
  localparam logic [31:0] VFSUMEXP_H_B       = 32'b1011101??????????010?????0110011;
  localparam logic [31:0] VFSUMEXP_AH_B      = 32'b1011101??????????010?????0110011;
  localparam logic [31:0] VFSUMEXP_H_AB      = 32'b1011101??????????010?????0110011;
  localparam logic [31:0] VFSUMEXP_AH_AB     = 32'b1011101??????????010?????0110011;
  ...
  localparam logic [31:0] VFSUM_AH           = 32'b1001010??????????010?????0110011;
  ...
  localparam logic [31:0] VFSUM_B            = 32'b1011100??????????011?????0110011;
  localparam logic [31:0] VFSUMEXP_B         = 32'b1011101??????????011?????0110011;
  localparam logic [31:0] VFDOTP_B           = 32'b1001010??????????011?????0110011;
  localparam logic [31:0] VFDOTP_R_B         = 32'b1001010??????????111?????0110011;
  localparam logic [31:0] VFDOTPEX_H_B       = 32'b1010111??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_H_R_B     = 32'b1010111??????????111?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_B      = 32'b1010111??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_R_B    = 32'b1010111??????????111?????0110011;
  localparam logic [31:0] FMULEX_S_AB        = 32'b0100111??????????????????1010011;
  localparam logic [31:0] FMACEX_S_AB        = 32'b0101011??????????????????1010011;
  localparam logic [31:0] VFSUM_AB           = 32'b1001010??????????000?????0110011;
  localparam logic [31:0] VFDOTP_AB          = 32'b1001010??????????011?????0110011;
  localparam logic [31:0] VFDOTP_R_AB        = 32'b1001010??????????111?????0110011;
  localparam logic [31:0] VFDOTPEX_H_AB      = 32'b1010111??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_H_R_AB    = 32'b1010111??????????111?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_AB     = 32'b1010111??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_R_AB   = 32'b1010111??????????111?????0110011;
