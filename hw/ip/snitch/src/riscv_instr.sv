...
package riscv_instr;
  ...
  localparam logic [31:0] VFSUMEX_S_H        = 32'b100011110110?????010?????0110011;
  localparam logic [31:0] VFNSUMEX_S_H       = 32'b101011110110?????010?????0110011;
  localparam logic [31:0] VFDOTPEX_S_H       = 32'b1001011??????????010?????0110011;
  localparam logic [31:0] VFDOTPEX_S_R_H     = 32'b1001011??????????110?????0110011;
  localparam logic [31:0] VFNDOTPEX_S_H      = 32'b1011101??????????010?????0110011;
  localparam logic [31:0] VFNDOTPEX_S_R_H    = 32'b1011101??????????110?????0110011;
  localparam logic [31:0] VFSUMEX_S_AH       = 32'b100011110110?????010?????0110011;
  localparam logic [31:0] VFNSUMEX_S_AH      = 32'b101011110110?????010?????0110011;
  localparam logic [31:0] VFDOTPEX_S_AH      = 32'b1001011??????????010?????0110011;
  localparam logic [31:0] VFDOTPEX_S_R_AH    = 32'b1001011??????????110?????0110011;
  localparam logic [31:0] VFNDOTPEX_S_AH     = 32'b1011101??????????010?????0110011;
  localparam logic [31:0] VFNDOTPEX_S_R_AH   = 32'b1011101??????????110?????0110011;
  localparam logic [31:0] VFSUMEX_H_B        = 32'b100011110111?????011?????0110011;
  localparam logic [31:0] VFNSUMEX_H_B       = 32'b101011110111?????011?????0110011;
  localparam logic [31:0] VFDOTPEX_H_B       = 32'b1001011??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_H_R_B     = 32'b1001011??????????111?????0110011;
  localparam logic [31:0] VFNDOTPEX_H_B      = 32'b1011101??????????011?????0110011;
  localparam logic [31:0] VFNDOTPEX_H_R_B    = 32'b1011101??????????111?????0110011;
  localparam logic [31:0] VFSUMEX_AH_B       = 32'b100011110111?????011?????0110011;
  localparam logic [31:0] VFNSUMEX_AH_B      = 32'b101011110111?????011?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_B      = 32'b1001011??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_R_B    = 32'b1001011??????????111?????0110011;
  localparam logic [31:0] VFNDOTPEX_AH_B     = 32'b1011101??????????011?????0110011;
  localparam logic [31:0] VFNDOTPEX_AH_R_B   = 32'b1011101??????????111?????0110011;
  localparam logic [31:0] VFSUMEX_H_AB       = 32'b100011110111?????011?????0110011;
  localparam logic [31:0] VFNSUMEX_H_AB      = 32'b101011110111?????011?????0110011;
  localparam logic [31:0] VFDOTPEX_H_AB      = 32'b1001011??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_H_R_AB    = 32'b1001011??????????111?????0110011;
  localparam logic [31:0] VFNDOTPEX_H_AB     = 32'b1011101??????????011?????0110011;
  localparam logic [31:0] VFNDOTPEX_H_R_AB   = 32'b1011101??????????111?????0110011;
  localparam logic [31:0] VFSUMEX_AH_AB      = 32'b100011110111?????011?????0110011;
  localparam logic [31:0] VFNSUMEX_AH_AB     = 32'b101011110111?????011?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_AB     = 32'b1001011??????????011?????0110011;
  localparam logic [31:0] VFDOTPEX_AH_R_AB   = 32'b1001011??????????111?????0110011;
  localparam logic [31:0] VFNDOTPEX_AH_AB    = 32'b1011101??????????011?????0110011;
  localparam logic [31:0] VFNDOTPEX_AH_R_AB  = 32'b1011101??????????111?????0110011;
