...
% endfor
    ...
    {
        name: "MSIP_BCAST_LENGTH",
        desc: "Set MSIP register bit for N harts, with N=MSIP_BCAST_LENGTH+1, starting from hart index MSIP_BCAST_OFFSET",
        hwqe: "true",
        swaccess: "wo",
        hwaccess: "hro",
        fields: [
          { bits: "31:0", name: "MSIP_BCAST_LENGTH", desc: "Set MSIP register bit for N harts, with N=MSIP_BCAST_LENGTH+1, starting from hart index MSIP_BCAST_OFFSET" }
        ]
    },
    {
        name: "MSIP_BCAST_OFFSET",
        desc: "Set MSIP register bit for N harts, with N=MSIP_BCAST_LENGTH+1, starting from hart index MSIP_BCAST_OFFSET",
        swaccess: "wo",
        hwaccess: "hro",
        fields: [
          { bits: "31:0", name: "MSIP_BCAST_OFFSET", desc: "Set MSIP register bit for N harts, with N=MSIP_BCAST_LENGTH+1, starting from hart index MSIP_BCAST_OFFSET" }
        ]
    },
  ]
}
