...
INSTR_SV=$ROOT/hw/ip/snitch_cluster/src/riscv_instr.sv
...
cd $ROOT/sw/vendor/riscv-opcodes && \
    cat opcodes opcodes-rvc opcodes-rvc-pseudo opcodes-pseudo opcodes-sflt | ./parse-opcodes -sverilog >> $INSTR_SV
