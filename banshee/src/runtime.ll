...
; Function Attrs: nofree norecurse nounwind nonlazybind writeonly
define void @banshee_dma_src(%DmaState* nocapture align 8 dereferenceable(32) %dma, i32 %lo, i32 %hi) unnamed_addr #0 {
start:
...
; Function Attrs: nofree norecurse nounwind nonlazybind writeonly
define void @banshee_dma_dst(%DmaState* nocapture align 8 dereferenceable(32) %dma, i32 %lo, i32 %hi) unnamed_addr #0 {
start:
  %_5 = zext i32 %hi to i64
  %_4 = shl nuw i64 %_5, 32
  %_7 = zext i32 %lo to i64
...
; Function Attrs: nounwind nonlazybind
define i32 @banshee_dma_strt(%DmaState* nocapture align 8 dereferenceable(32) %dma, i8* %cpu, i32 %size, i32 %flags) unnamed_addr #2 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality {
start:
  ...
  %_8 = and i32 %flags, 2
  %enable_2d = icmp eq i32 %_8, 0
  %2 = getelementptr inbounds %DmaState, %DmaState* %dma, i64 0, i32 9
  %3 = load i32, i32* %2, align 8
  %narrow = select i1 %enable_2d, i32 1, i32 %3
  %steps.0 = zext i32 %narrow to i64
  %4 = icmp eq i32 %narrow, 0
  br i1 %4, label %bb7, label %bb9.lr.ph

bb9.lr.ph:                                        ; preds = %start
  %num_beats = lshr i32 %size, 2
  %5 = getelementptr inbounds %DmaState, %DmaState* %dma, i64 0, i32 0, i64 0
  %6 = getelementptr inbounds %DmaState, %DmaState* %dma, i64 0, i32 5
  %7 = getelementptr inbounds %DmaState, %DmaState* %dma, i64 0, i32 3
  %8 = getelementptr inbounds %DmaState, %DmaState* %dma, i64 0, i32 7
  %_40 = zext i32 %num_beats to i64
  %9 = icmp eq i32 %num_beats, 0
  br i1 %9, label %bb7, label %bb9.us

bb9.us:                                           ; preds = %bb9.lr.ph, %bb11.bb5.loopexit_crit_edge.us
  %iter.sroa.0.040.us = phi i64 [ %11, %bb11.bb5.loopexit_crit_edge.us ], [ 0, %bb9.lr.ph ]
  %_27.us = load i64, i64* %5, align 8
  %_31.us = load i32, i32* %6, align 8
  %_30.us = zext i32 %_31.us to i64
  %_28.us = mul i64 %iter.sroa.0.040.us, %_30.us
  %src.us = add i64 %_28.us, %_27.us
  %_33.us = load i64, i64* %7, align 8
  %_37.us = load i32, i32* %8, align 4
  %_36.us = zext i32 %_37.us to i64
  %_34.us = mul i64 %iter.sroa.0.040.us, %_36.us
  %dst.us = add i64 %_34.us, %_33.us
  br label %bb15.us

bb15.us:                                          ; preds = %bb15.us, %bb9.us
  %iter1.sroa.0.039.us = phi i64 [ 0, %bb9.us ], [ %10, %bb15.us ]
  %10 = add nuw nsw i64 %iter1.sroa.0.039.us, 1
  %_56.us = shl i64 %iter1.sroa.0.039.us, 2
  %_54.us = add i64 %src.us, %_56.us
  %_53.us = trunc i64 %_54.us to i32
  %tmp.us = tail call i32 @banshee_load(i8* %cpu, i32 %_53.us, i8 zeroext 2)
  %_61.us = add i64 %dst.us, %_56.us
  %_60.us = trunc i64 %_61.us to i32
  tail call void @banshee_store(i8* %cpu, i32 %_60.us, i32 %tmp.us, i8 zeroext 2)
  %exitcond = icmp eq i64 %10, %_40
  br i1 %exitcond, label %bb11.bb5.loopexit_crit_edge.us, label %bb15.us

bb11.bb5.loopexit_crit_edge.us:                   ; preds = %bb15.us
  %11 = add nuw nsw i64 %iter.sroa.0.040.us, 1
  %exitcond42 = icmp eq i64 %11, %steps.0
  br i1 %exitcond42, label %bb7, label %bb9.us

bb7:                                              ; preds = %bb11.bb5.loopexit_crit_edge.us, %bb9.lr.ph, %start
  ret i32 %id
}

; Function Attrs: norecurse nounwind nonlazybind readonly
define i32 @banshee_dma_stat(%DmaState* noalias nocapture readonly align 8 dereferenceable(32) %dma, i32 %addr) unnamed_addr #1 {
start:
  %_3 = and i32 %addr, 3
...
; Function Attrs: nounwind nonlazybind
declare i32 @banshee_load(i8*, i32, i8 zeroext) unnamed_addr #2

; Function Attrs: nounwind nonlazybind
declare void @banshee_store(i8*, i32, i32, i8 zeroext) unnamed_addr #2
