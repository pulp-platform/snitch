...
This is purely intended for the `spike-dasm` disassembler and tailored to the
Snitch system. The the opcodes are generated by

	cat opcodes opcodes-rvc-pseudo opcodes-rvc \
	  opcodes-rep opcodes-flt-occamy opcodes-dma opcodes-ssr \
      | ./parse-opcodes -c >> riscv/encoding.h
    cp riscv/encoding.h fesvr/encoding.h
