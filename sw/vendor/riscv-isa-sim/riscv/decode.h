...
#define insn_length(x)                                                         \
  (((x)&0x03) < 0x03 ? 2 : ((x)&0x1f) < 0x1f ? 4 : ((x)&0x3f) < 0x3f ? 6 : 8)
...
public:
  ...
  uint64_t i_uimm12() { return uint64_t(b) >> 20; }
  int64_t rep_num_inst() { return uint64_t(b) >> 20; }
  int64_t rep_stagger_max() { return x(12, 3); }
  int64_t rep_stagger_mask() { return x(11, 4); }
  uint64_t dm_imm() { return x(20, 5); }

  int64_t rvc_imm() { return x(2, 5) + (xs(12, 1) << 5); }
  int64_t rvc_zimm() { return x(2, 5) + (x(12, 1) << 5); }
  int64_t rvc_addi4spn_imm() {
    return (x(6, 1) << 2) + (x(5, 1) << 3) + (x(11, 2) << 4) + (x(7, 4) << 6);
  }
  int64_t rvc_addi16sp_imm() {
    return (x(6, 1) << 4) + (x(2, 1) << 5) + (x(5, 1) << 6) + (x(3, 2) << 7) +
           (xs(12, 1) << 9);
  }
  ...
  int64_t rvc_j_imm() {
    return (x(3, 3) << 1) + (x(11, 1) << 4) + (x(2, 1) << 5) + (x(7, 1) << 6) +
           (x(6, 1) << 7) + (x(9, 2) << 8) + (x(8, 1) << 10) +
           (xs(12, 1) << 11);
  }
  int64_t rvc_b_imm() {
    return (x(3, 2) << 1) + (x(10, 2) << 3) + (x(2, 1) << 5) + (x(5, 2) << 6) +
           (xs(12, 1) << 8);
  }
