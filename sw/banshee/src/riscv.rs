...
impl std::fmt::Display for OpcodeRdRs1Rs2 {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::VfdotpexaSB => write!(f, "vfdotpexa.s.b"),
            Self::VfdotpexaSRB => write!(f, "vfdotpexa.s.r.b"),
            Self::VfdotpexbSB => write!(f, "vfdotpexb.s.b"),
            Self::VfdotpexbSRB => write!(f, "vfdotpexb.s.r.b"),
...
pub fn parse_u32(raw: u32) -> Format {
    ...
    match raw & 0xfe00707f {
        ...
        0xb8000033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfdotpexaSB, raw),
        0xb8004033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfdotpexaSRB, raw),
        0xbc000033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfdotpexbSB, raw),
        0xbc004033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfdotpexbSRB, raw),
