...
pub fn parse_u32(raw: u32) -> Format {
    ...
    match raw & 0xfe00707f {
        ...
        0xbc002033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumexSH, raw),
        0xbe002033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfnsumexSH, raw),
        ...
        0xba002033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfndotpexSH, raw),
        0xba006033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfndotpexSRH, raw),
        0xbc003033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumexHB, raw),
        0xbe003033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfnsumexHB, raw),
        0x96003033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfdotpexHB, raw),
        0x96007033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfdotpexHRB, raw),
        0xba003033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfndotpexHB, raw),
        0xba007033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfndotpexHRB, raw),
        _ => (),
    }
