...
declare i32 @banshee_ssr_indirect(%SsrState* %ssr, %Cpu* readonly %cpu)
declare void @banshee_ssr_write_cfg(%SsrState* %ssr,  %Cpu* readonly %cpu, i32 %addr, i32 %value, i32 %mask)
declare i32 @banshee_ssr_read_cfg(%SsrState* readonly %ssr, i32 %addr)
declare i32 @banshee_ssr_next(%SsrState* %ssr, %Cpu* readonly %cpu)
