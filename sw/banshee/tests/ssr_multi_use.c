...
// Requires LLVM toolchain with builtins support for the Xssr extension
...
int main() {
    ...
    __builtin_ssr_setup_1d(0, /*rep*/ 0, /*bound*/ 8 - 1, /*stride*/ 8,
                           /*data*/ x);
    __builtin_ssr_setup_1d(1, /*rep*/ 0, /*bound*/ 8 - 1, /*stride*/ 8,
                           /*data*/ y);
    ...
    asm volatile(
        ...
        // same for ft1
        // TODO: uncomment this test once repeated frep in banshee is fixed
        // "li t0, 4-1\n"
        // "fcvt.d.w %[tmp], x0\n"
        // "frep.o t0, 1, 0, 0b0000\n"
