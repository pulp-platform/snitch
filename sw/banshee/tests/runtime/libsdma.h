...
// 1D transfer
inline volatile static uint32_t sdma__start_oned (
                                volatile uint32_t src_low,
...
inline volatile static uint32_t sdma__start_twod (
                                ...
                                volatile uint32_t dst_high,
                                volatile uint32_t num_bytes,
                                volatile uint32_t src_strd,
                                volatile uint32_t dst_strd,
                                volatile uint32_t num_reps
) {
