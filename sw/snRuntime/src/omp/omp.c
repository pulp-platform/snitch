/*
* @Author: Noah Huetter
* @Date:   2020-11-06 10:49:51
* @Last Modified by:   Noah Huetter
* @Last Modified time: 2020-11-13 14:48:18
*/
...
void omp_init(void)
{
  ...
  for(int i = 0; i < sizeof(_this->plainTeam.core_epoch)/sizeof(_this->plainTeam.core_epoch[0]); i++) _this->plainTeam.core_epoch[i] = 0;
...
void partialParallelRegion(int32_t argc, void *data, void (*fn) (void*,uint32_t), int num_threads)
{
