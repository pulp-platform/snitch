...
//         __builtin_ssr_setup_1d_r(0, 0, AXPY_N / NUMTHREADS - 1,
//         sizeof(double),
//                                  &data_x[AXPY_N / 8 * omp_get_thread_num()]);
//         __builtin_ssr_setup_1d_r(1, 0, AXPY_N / NUMTHREADS - 1,
//         sizeof(double),
//                                  &data_y[AXPY_N / 8 * omp_get_thread_num()]);
//         __builtin_ssr_setup_1d_w(2, 0, AXPY_N / NUMTHREADS - 1,
//         sizeof(double),
//                                  &data_y[AXPY_N / 8 * omp_get_thread_num()]);
